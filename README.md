...
#### En el presente trabajo se muestra el modelado cinemático y dinámico (en su forma directa e inversa) de un robot de cuatro grados de libertad al seguir una trayectoría, la cual se generó con el fin de que el robot sea capaz de tomar desechos plásticos de una banda transportadora y los deposite en un contenedor de acuerdo al tipo de plástico. El modelado cinemático y dinámico se validó mediante la obtención de gráficas y simulaciones, las cuales permitieron garantizar que el robot no presenta problemas al llevar a cabo la  tarea asignada, ya que no se observaron singularidades, además que las aceleraciones que se obtuvieron no presentan un riesgo en cuanto a esfuerzos.

#### El desarrollo del proyecto permitió aplicar y entender las bases teóricas de la robótica, lo cual fue de gran ayuda para comprender los elementos que constituyen a los robots, así como las configuraciones existentes y las propiedades de los mismos. Por otro lado, también nos permitió desarrollar nuestras habilidades tecnológicas, ya que usamos herramientas como matlab, simulink, solidworks y github para llevar a cabo dicho proyecto.
