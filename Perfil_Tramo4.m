...
plot(time,a3,'b*');
hold on
title('Posición espacio cartesiano T4')
xlabel('Tiempo[s]')
...
plot(time,a3p,'b*');
hold on
title('Velocidad espacio cartesiano T4')
xlabel('Tiempo [s]')
...
plot(time,a3pp,'b*');
hold on
title('Aceleración espacio cartesiano T4')
xlabel('Tiempo [s]')
...
title('Espacio de juntas en posición T4');
xlabel('Tiempo [s]');
ylabel('Grados');
legend('q1','q2','q3');
grid on;
...
title('Espacio de juntas en velocidad T4');
xlabel('Tiempo [s]');
ylabel('Grados/s');
legend('q1p','q2p','q3p');
grid on;
...
title('Espacio de juntas en aceleración T4');
xlabel('Tiempo [s]');
ylabel('Grados/seg^2');
